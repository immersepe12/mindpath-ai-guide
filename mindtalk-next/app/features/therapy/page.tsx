    ...
    <>
      ...
      <main>
        <FeatureHero
          ...
          primaryScreenshot="/screenshots/TherapistBookingRedesign.png"
          secondaryScreenshot="/screenshots/TherapistMatchIntake.png"
          background="cream"
          badges={
            <Link
              href="/quiz"
        ...
        <section className="bg-white py-20 border-t border-[#ECE6DE]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-center">
              <Image
                src="/screenshots/TherapistMatchIntake.png"
                alt="Therapist match intake screen"
                width={500}
                height={1050}
