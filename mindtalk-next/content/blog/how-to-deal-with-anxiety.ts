...
// Source: Mindtalk marketing package/seo_content/blog_01_how_to_deal_with_anxiety.md
// Body is verbatim markdown — do not paraphrase.
export const post: BlogPost = {
  slug: 'how-to-deal-with-anxiety',
  title: 'How to Deal With Anxiety: 7 CBT Techniques That Actually Work',
  metaTitle: 'How to Deal With Anxiety: 7 CBT Techniques That Work | MindTalk',
  metaDescription:
    "Learn 7 evidence-based CBT techniques to deal with anxiety. Practical steps you can start today — from a programme backed by Cadabams, India's leading mental health group.",
  primaryKeyword: 'how to deal with anxiety',
  secondaryKeywords: [
  ...
  author: 'MindTalk Clinical Team',
  reviewer: 'Reviewed by a Cadabams Mental Health Professional',
  cluster: 'Anxiety Recovery',
  ctaJourney: 'Anxiety',
  faqItems: [
    {
      q: 'How long does it take for CBT to work for anxiety?',
      a: 'Most people notice meaningful improvement within 6-12 weeks of consistent CBT practice. Significant changes are typically seen at the 30-day mark with structured daily exercises.',
    },
    {
      q: 'What is the fastest way to relieve anxiety right now?',
      a: 'Use controlled breathing (4-7-8 method) or the 5-4-3-2-1 grounding exercise. These activate the parasympathetic nervous system and reduce physical anxiety symptoms within minutes.',
    },
    {
      q: 'Is CBT better than medication for anxiety?',
      a: 'CBT produces longer-lasting results because it changes underlying thought patterns. Many guidelines recommend CBT as first-line treatment. Always consult a qualified professional.',
    },
    {
      q: 'Can I do CBT for anxiety on my own?',
      a: 'You can practise techniques independently, but structured guided programmes are significantly more effective. Apps like MindTalk provide structured guidance without the full cost of private therapy.',
    },
    {
      q: 'Is online therapy effective for anxiety?',
      a: 'Yes. Multiple meta-analyses confirm online CBT is as effective as in-person CBT for anxiety. The key is structure and consistency in the programme.',
    },
  ],
  content: `**Anxiety affects over 197 million Indians** — yet most people are never told *how* to actually work through it. The good news: Cognitive Behavioural Therapy (CBT) gives you a practical, proven toolkit. Here are 7 techniques you can start using today, drawn from the same methods used in MindTalk's structured anxiety recovery programme.

---

> **Quick answer:** To deal with anxiety, use CBT techniques: identify and challenge anxious thoughts, use controlled breathing, practise gradual exposure to feared situations, schedule worry time, build behavioural activation, use grounding exercises, and track your progress in a journal. These work best as a structured programme — not one-offs.
...
**Key Facts:**
- CBT is the gold-standard treatment for anxiety disorders, with 60–80% effectiveness rates (NCBI, 2021)
- The average person with untreated anxiety waits **11 years** before seeking help (WHO, 2022)
- Structured, daily CBT practice outperforms weekly therapy sessions alone by 40% at 6-month follow-up (Journal of Consulting and Clinical Psychology, 2019)
...
### How to do it
1. **Catch the thought.** When you feel anxious, write down the exact thought: *"I'm going to embarrass myself in the meeting."*
2. **Ask: What's the evidence?** What evidence supports this? What contradicts it?
3. **Find the cognitive distortion.** Is it catastrophising? Mind-reading? All-or-nothing thinking?
4. **Write a balanced thought.** *"I may feel nervous, but I've presented successfully before. Most people are focused on their own work, not judging me."*
5. **Rate your anxiety before and after** on a scale of 0–10.
...
### How to do it
1. **List your anxiety triggers** from least to most feared (this is your "fear ladder").
2. **Start at the bottom.** Confront the mildest trigger until your anxiety drops by 50% or more.
3. **Move up the ladder** only when you feel comfortable at the current step.
4. **Never escape mid-exposure** — this reinforces avoidance. Stay until anxiety peaks and then naturally subsides.
...
### How to do it
1. Choose a fixed time — say, 5:00–5:20pm.
2. When an anxious thought arrives during the day, note it down briefly, then tell yourself: *"I'll deal with this at 5pm."*
3. At your worry window, sit with your worry list, problem-solve what you can, and accept what you can't control.
4. When time is up, stop — regardless of whether you've "solved" everything.
...
### How to do it
1. List 10 activities that gave you a sense of pleasure or achievement in the past.
2. Schedule at least 2–3 per week in your calendar (not as options — as appointments).
3. After each activity, rate your mood (0–10). Notice the pattern over 2 weeks.
...
1. Morning anxiety rating (0–10)
2. Key trigger of the day
3. Technique used and its effect
4. One small win
...
- [What Is CBT Therapy? A Complete Guide for Indians](/blog/what-is-cbt-therapy)
- [How to Recover From Depression: A Structured 90-Day Approach](/blog/how-to-recover-from-depression)

---

## About MindTalk

MindTalk is a structured CBT recovery programme by Cadabams Group — India's largest mental health organisation with 30+ years of clinical experience. The programme combines daily CBT exercises, self-care tools, a journaling system, and weekly therapist sessions into a single 90-day recovery journey. Packages from ₹7,799 at [cadabamsmindtalk.com](/anxiety).
