          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="relative order-2 lg:order-1 hidden lg:block">
              <div className="mx-auto w-72 md:w-80 h-[600px] md:h-[700px] bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl">
                <div className="w-full h-full bg-gradient-to-b from-mindtalk-orange to-mindtalk-orange rounded-[2rem] overflow-hidden relative">
                  ...
                  {/* Status Bar */}
                  <div className="flex justify-between items-center p-3 md:p-4 text-white text-xs md:text-sm">
                    <span>3:55</span>
                    <div className="flex items-center gap-1">
                      <div className="flex gap-1">
                        <div className="w-1 h-2 md:h-3 bg-white rounded"></div>
                        <div className="w-1 h-2 md:h-3 bg-white rounded"></div>
                        <div className="w-1 h-2 md:h-3 bg-white rounded"></div>
                        <div className="w-1 h-2 md:h-3 bg-white/50 rounded"></div>
                      </div>
                      <span>📶</span>
                      <span>📶</span>
                  ...
                  <div className="px-3 md:px-4 pb-3 md:pb-4">
                    <div className="flex justify-between items-center text-white">
                      <h3 className="text-base md:text-lg font-semibold">Your Journey</h3>
                      <div className="flex items-center gap-1">
                        <Star className="w-3 h-3 md:w-4 md:h-4 fill-yellow-400 text-yellow-400" />
                        <span className="text-xs md:text-sm">15 Stars</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mx-3 md:mx-4 mb-3 md:mb-4">
                    <Card className="bg-white/95 border-0">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="text-mindtalk-orange font-semibold mb-2 md:mb-3 text-sm md:text-base">90 days Emotional Reset</h4>
                        <Progress value={50} className="mb-1 md:mb-2" />
                        <p className="text-xs md:text-sm text-gray-600 mb-1 md:mb-2">50% Complete</p>
                  ...
                  <div className="mx-3 md:mx-4 mb-3 md:mb-4">
                    <Card className="bg-white/95 border-0">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="font-semibold text-mindtalk-orange mb-1 text-sm md:text-base">Day 16 - August 20, 2025</h4>
                        <p className="text-xs md:text-sm text-mindtalk-green mb-2 md:mb-3">Available now</p>
                        
                        <div className="flex justify-between items-center mb-2 md:mb-3">
                          <span className="text-xs md:text-sm text-gray-600">Tasks Completed:</span>
                          <span className="text-xs md:text-sm font-medium text-mindtalk-orange">0/3</span>
                        </div>
                        <Progress value={0} className="mb-3 md:mb-4" />

                        {/* Sample Task */}
                        <div className="space-y-2 md:space-y-3">
                          <div className="border rounded-lg p-2 md:p-3">
                            <div className="flex justify-between items-start mb-1 md:mb-2">
                              <h5 className="font-medium text-gray-900 text-sm md:text-base">The Role of Guilt</h5>
                              <Info className="w-3 h-3 md:w-4 md:h-4 text-gray-400 flex-shrink-0" />
                            </div>
                            <p className="text-xs text-gray-600 mb-1 md:mb-2">Assessment for Building Emotional Strength</p>
                            <p className="text-xs text-mindtalk-orange font-medium mb-2 md:mb-3">Assessment Required</p>
                            <button className="w-full bg-mindtalk-orange text-white py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium">
                              Start
                            </button>
                          </div>
                        </div>
                  ...
                  <div className="mx-3 md:mx-4">
                    <Card className="bg-white/95 border-0">
                      <CardContent className="p-3 md:p-4">
                        <h4 className="text-mindtalk-orange font-semibold mb-2 md:mb-3 text-sm md:text-base">Journey Calendar</h4>
                          ...
                          {days.slice(0, 21).map((day) => (
                            <div key={day.day} className="text-center">
                              <div className={`w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center text-xs ${
                                ...
                                {day.status === 'completed' && <Star className="w-2 h-2 md:w-3 md:h-3 fill-white" />}
                                {day.status === 'current' && day.day}
                                {day.status === 'future' && day.day}
                              </div>
                              <span className="text-xs text-gray-500 mt-0.5 md:mt-1 block hidden md:inline">Day {day.day}</span>
                            </div>
                          ))}
                        </div>
                      </CardContent>
            ...
            <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                <Card className="p-3 md:p-4 border border-mindtalk-orange/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-mindtalk-orange rounded-lg flex items-center justify-center">
                      <Calendar className="w-4 h-4 md:w-5 md:h-5 text-white" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">90-Day Calendar</h4>
                      <p className="text-xs md:text-sm text-gray-600">Visual progress tracking</p>
                    </div>
                  </div>
                </Card>

                <Card className="p-3 md:p-4 border border-mindtalk-green/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-mindtalk-green rounded-lg flex items-center justify-center">
                      <Star className="w-4 h-4 md:w-5 md:h-5 text-white" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Earn Stars</h4>
                      <p className="text-xs md:text-sm text-gray-600">Daily achievements</p>
                    </div>
                  </div>
                </Card>

                <Card className="p-3 md:p-4 border border-mindtalk-blue/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-mindtalk-blue rounded-lg flex items-center justify-center">
                      <Target className="w-4 h-4 md:w-5 md:h-5 text-white" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Daily Tasks</h4>
                      <p className="text-xs md:text-sm text-gray-600">Structured micro-tasks</p>
                    </div>
                  </div>
                </Card>

                <Card className="p-3 md:p-4 border border-mindtalk-purple/20">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-mindtalk-purple rounded-lg flex items-center justify-center">
                      <Trophy className="w-4 h-4 md:w-5 md:h-5 text-white" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Progress Tracking</h4>
                      <p className="text-xs md:text-sm text-gray-600">Real-time insights</p>
                    </div>
                  </div>
                </Card>
              </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  {dailyTasks.map((task, index) => (
                    <Card key={index} className="border border-gray-200">
                      <CardContent className="p-3 md:p-4">
                        <div className="flex justify-between items-start mb-1 md:mb-2">
                          <h5 className="font-medium text-gray-900 text-sm md:text-base pr-2">{task.title}</h5>
                          <Info className="w-3 h-3 md:w-4 md:h-4 text-gray-400 flex-shrink-0" />
                        </div>
                        <p className="text-xs md:text-sm text-gray-600 mb-1 md:mb-2">{task.subtitle}</p>
                        <p className="text-xs md:text-sm text-mindtalk-orange font-medium mb-2 md:mb-3">{task.type}</p>
                        <div className="flex items-center justify-between">
                          <span className="text-xs text-gray-500">Part of your daily journey</span>
                          <button className="bg-mindtalk-orange text-white px-3 md:px-4 py-1 rounded-lg text-xs md:text-sm">
                            {task.buttonText}
                          </button>
                        </div>
                      </CardContent>
